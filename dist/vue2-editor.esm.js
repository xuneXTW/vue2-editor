...
var script = {
  ...
  methods: {
    initializeEditor: function initializeEditor() {
      ...
      this.checkForCustomImageHandler(); //this.handleInitialContent();
